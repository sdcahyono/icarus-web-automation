...
const formatted = yy + mm + dd + '_' + hh + min + ss ;
...
//        './feature/clp.feature'
    ...
    baseUrl: 'https://uat-internal.thebodyshop.co.id/',
    // baseUrl: {
    //     staging: 'https://web.staging-v1.tbsgroup.co.id/',
    //     preprod: 'https://uat-internal.thebodyshop.co.id/'
    // },
    // baseUrl: process.env.BASE_URL || 'https://uat-internal.thebodyshop.co.id/',
    // baseUrl: (() => {
    ...
    //     disableWebdriverStepsReporting: fa,
    ...
    reporters: ['spec',['timeline', {
        ...
        fileName: 'automation-web-' + formatted +'.html',
        images: {
          quality: 50,
          resize: true,
          reductionRatio:2
    ...
    //   outputDir: './test-reports/html-reports/', // Set the output directory for HTML reports
    //   filename: 'report.html', // Specify the HTML report file name
    //   reportTitle: 'WebdriverIO Test Report', // Set the report title
    //   showInBrowser: true, // Optionally open the report in the default browser
    //   screenshotPath: './test-reports/html-reports/',
    // }]],
